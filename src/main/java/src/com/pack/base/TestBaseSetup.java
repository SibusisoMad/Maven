...
public class TestBaseSetup  {
	...
	private static WebDriver initphoneChromeDriver(String appURL) {
		...
		String basePath = new File("").getAbsolutePath();
	     ...
	     String path = new File("/src/test/resources/Drivers/chromedriver.exe").getAbsolutePath();
...
//			}
	...
	private static WebDriver initFirefoxDriver(String appURL) { 
        ...
        String path = new File("/src/test/resources/Drivers/geckodriver.exe").getAbsolutePath();
